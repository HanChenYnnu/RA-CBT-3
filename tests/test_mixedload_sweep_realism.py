...
def test_mixedload_gate_shape() -> None:
    rows = [
        _row("1.00", 0.995, 0.005, 0.05, 0.28, 0.62, 1000),
        _row("0.70", 0.985, 0.008, 0.08, 0.26, 0.60, 800),
        _row("0.50", 0.972, 0.010, 0.12, 0.24, 0.58, 680),
        _row("0.35", 0.958, 0.014, 0.18, 0.23, 0.56, 620),
        _row("0.25", 0.940, 0.020, 0.22, 0.22, 0.54, 590),
    ]
