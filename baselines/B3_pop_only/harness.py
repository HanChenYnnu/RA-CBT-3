    ...
    with TestClient(app) as client:
        ...
        if scenario in {"S1_key_leak", "S1_key_leak_hard"}:
            ...
            for idx, req in enumerate(requests):
                ...
                record_sample(scenario=scenario, baseline="B3", caps=manifest, auth_present=True, dpop_present=True, exchange_called=True, replay_key="")
            ...
            for idx, req in enumerate(requests):
                ...
                record_sample(scenario=scenario, baseline="B3", caps=manifest, auth_present=True, dpop_present="DPoP" in headers, exchange_called=False, replay_key="")
            ...
            for idx, req in enumerate(requests):
                ...
                record_sample(scenario=scenario, baseline="B3", caps=manifest, auth_present=True, dpop_present=True, exchange_called=False, replay_key=replay_key)
