...
def main() -> None:
    ...
    b4_brier, b4_ece, reliability_bins = compute_b4_calibration_metrics(all_events)
    ...
    plots = generate_plots(rows, roc_points=roc_points, reliability_bins=reliability_bins)
